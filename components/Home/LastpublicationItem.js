        ...
        <View style={styles.main}>
            ...
            <View style={styles.publish}>
                ...
                <View style={styles.nameItem}>
                    <Text style={{fontSize: 20, fontWeight:'bold'}}>Boueng Ekwa Raoul</Text>
            ...
            <View>
                <Text style={{margin: 10}}>
                    lreum lreum um lreum um lreum um lreum um lreumv um lreum um lreum
                    um lreum lifjofj outio kshfklghlj lmudgwuidkn
                </Text>
            </View>
...
export default LastPublicationItem;